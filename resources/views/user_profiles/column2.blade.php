...
@section('content')
    ...
    <div class="content">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="row">
                    <form method="post" action="{{url('new/customer/column')}}">
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <input type="text" name="pos" id="pos" class="form-control" value="{{$position}}" placeholder="Please Enter the Position">
                        </div>
                        <div class="form-group col-sm-12">
                            <label>Column Type</label>
                            <select name="type" class="form-control">
                                <option value="" selected disabled>Select one type</option>
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <a href="{!! url('show/customer/columns') !!}" class="btn btn-default">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
