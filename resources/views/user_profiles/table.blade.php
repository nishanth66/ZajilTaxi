<?php
    ...
    $columns = \Illuminate\Support\Facades\DB::table('driver_profile_status')->orderby('position')->get();
?>
    ...
    @foreach($columns as $column)
        ...
        <tr>
            ...
            <td><button type="button" class="btn btn-danger" onclick="actionBtn({{$column->id}})">Disable</button>
                ...
                <a href="{{url("deleteDColumn").'/'.$column->id}}" style="color:red"> <i class="fa fa-trash" style="color: red;cursor: pointer;" aria-hidden="true"></i></a>
            </td>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="{{url('edit/column')}}">
                            {{csrf_field()}}
